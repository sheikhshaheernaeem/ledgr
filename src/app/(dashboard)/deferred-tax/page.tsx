        ...
        <DialogContent>
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1"><Label>Type</Label><Select value={form.type} onValueChange={(v: string | null) => setForm(f => ({ ...f, type: v ?? '' }))}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="ASSET">Deferred Tax Asset</SelectItem><SelectItem value="LIABILITY">Deferred Tax Liability</SelectItem></SelectContent></Select></div>
            </div>
