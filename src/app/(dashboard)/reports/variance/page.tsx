      ...
      <Card>
        <CardContent className="pt-4">
          <div className="flex items-end gap-3">
            ...
            <div className="space-y-1">
              <Label>Period</Label>
              <Select value={month} onValueChange={(v: string | null) => setMonth(v ?? '')}><SelectTrigger className="w-36"><SelectValue /></SelectTrigger><SelectContent>{MONTHS.map((m, i) => <SelectItem key={i} value={String(i)}>{m}</SelectItem>)}</SelectContent></Select>
            </div>
